...
txtDisplay.grid(row=0,column=0, columnspan=4,padx=5 ,pady=5)
...
btntanh = Button(calc, text="tanh",width=6, 
                ...
                ).grid(row=2, column= 6,padx=10, pady = 10)
...
btnMod = Button(calc, text="Mod",width=6,
                ...
                ).grid(row=3, column= 6,padx=10, pady = 10)
 
btnE   = Button(calc, text="e",width=6, 
                height=2,bg='black',fg='white',
                font=('Helvetica',20,'bold'),
                bd=4,command=added_value.e
               ).grid(row=3, column= 7,padx=10, pady = 10)
...
btncos   = Button(calc, text="log1p",width=6,
                 ...
                 ).grid(row=4, column= 5,padx=10, pady = 10)
 
btnexpm1 = Button(calc, text="expm1",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd = 4,command=added_value.expm1
                 ).grid(row=4, column= 6,padx=10, pady = 10)
 
btngamma = Button(calc, text="gamma",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.lgamma
                 ).grid(row=4, column= 7,padx=10, pady = 10)
# ROW 5 :
...
btndeg = Button(calc, text="deg",width=6, 
               ...
               ).grid(row=5, column= 5,padx=10, pady = 10)
 
btnacosh = Button(calc, text="acosh",width=6,
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.acosh
                 ).grid(row=5, column= 6,padx=10, pady = 10)
 
btnasinh = Button(calc, text="asinh",width=6, 
                  height=2,bg='black',fg='white',
                  font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.asinh
                 ).grid(row=5, column= 7,padx=10, pady = 10)
